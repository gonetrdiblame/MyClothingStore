...
<body>
    ...
    <div class="container">
        <div class="row py-2 justify-content-center h5">
            <h3 class="text-center">Editare Categorie</h3>
        </div>
        <div class="row">
            <div class="col-md-6 m-auto form-container">
                ...
                <form action="/categories/update/<?=$category->id?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nume" id="nume" class="form-control" value="<?=$category->nume?>" placeholder="Introduceti numele categoriei" required>
                    </div>
                    <button type="submit" class="btn btn-dark btn-sm">Actualizează Categorie</button>
                </form>
            </div>
        </div>
    </div>
